...
public class DockerComposeFilesShould {
    ...
    public void generate_docker_compose_file_command_correctly_for_single_compose_file() throws Exception {
        ...
        assertThat(dockerComposeFiles.constructComposeFileCommand()).containsExactly("--file", composeFile.getAbsolutePath());
    }
    ...
    public void generate_docker_compose_file_command_correctly_for_multiple_compose_files() throws Exception {
        ...
        assertThat(dockerComposeFiles.constructComposeFileCommand()).containsExactly("--file", composeFile1.getAbsolutePath(), "--file", composeFile2.getAbsolutePath());
    }
}
