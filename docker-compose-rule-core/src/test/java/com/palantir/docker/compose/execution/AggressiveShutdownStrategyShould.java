...
public class AggressiveShutdownStrategyShould {
    ...
    public void call_down_on_down() throws Exception {
        ...
        ShutdownStrategy.AGGRESSIVE.down(dockerCompose);
    ...
    public void do_nothing_on_shutdown() throws Exception {
        ...
        ShutdownStrategy.AGGRESSIVE.shutdown(dockerCompose, docker);
