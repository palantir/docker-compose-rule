...
public class ContainerShould {
    ...
    public void not_have_all_ports_open_if_has_at_least_one_closed_port_and_report_the_name_of_the_port()
        ...
        assertThat(container.areAllPortsOpen()).is(new HamcrestCondition<>(is(failureWithMessage(containsString(unavailablePortString)))));
    }
    ...
    public void be_listening_on_http_when_the_port_is() throws Exception {
        ...
        assertThat(container.portIsListeningOnHttp(2345, port -> "http://some.url:" + port)).is(new HamcrestCondition<>(is(successful())));
    }
    ...
    public void not_be_listening_on_http_when_the_port_is_not_and_reports_the_port_number_and_url() throws Exception {
        ...
        assertThat(container.portIsListeningOnHttp(unavailablePort, port -> "http://some.url:" + port.getInternalPort())).is(new HamcrestCondition<>(is(failureWithMessage(both(containsString(unvaliablePortString))
