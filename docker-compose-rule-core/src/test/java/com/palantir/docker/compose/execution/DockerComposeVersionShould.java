...
public class DockerComposeVersionShould {
    ...
    public void compare_major_versions_first() {
        assertThat(Version.valueOf("2.1.0").compareTo(Version.valueOf("1.2.1"))).is(new HamcrestCondition<>(greaterThan(0)));
    }

    @Test
    public void compare_minor_versions_when_major_versions_are_the_same() {
        assertThat(Version.valueOf("2.1.7").compareTo(Version.valueOf("2.3.2"))).is(new HamcrestCondition<>(lessThan(0)));
    }
