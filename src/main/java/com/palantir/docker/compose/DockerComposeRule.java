...
public abstract class DockerComposeRule extends ExternalResource {
    ...
    public static class Builder extends ImmutableDockerComposeRule.Builder {
        ...
        public Builder waitingForService(String serviceName, HealthCheck<Container> healthCheck, Duration timeout) {
        ...
        public Builder waitingForServices(List<String> services, HealthCheck<List<Container>> healthCheck, Duration timeout) {
        ...
        public Builder waitingForHostNetworkedPort(int port, HealthCheck<DockerPort> healthCheck, Duration timeout) {
